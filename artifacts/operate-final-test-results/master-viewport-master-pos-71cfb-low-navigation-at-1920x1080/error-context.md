...
- Name: master-viewport.spec.ts >> master poster fits below navigation at 1920x1080
- Location: tests\master-viewport.spec.ts:4:7

# Error details

```
Error: UNKNOWN: unknown error, open 'D:\SYCP_PPL\work_report\artifacts\master-viewport-1920.png'
```
