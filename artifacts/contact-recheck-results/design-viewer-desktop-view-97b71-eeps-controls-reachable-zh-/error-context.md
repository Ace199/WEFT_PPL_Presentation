...
Locator: locator('[data-panel][data-active="true"] [data-card-part="example"] p').last()
Expected: in viewport
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeInViewport" locator('[data-panel][data-active="true"] [data-card-part="example"] p').last() with timeout 5000ms
  - waiting for locator('[data-panel][data-active="true"] [data-card-part="example"] p').last()
...
```ts
  ...
  87  |       await expect(
  88  |         page.locator(i === 3 ? '#decision-task-composition figcaption' : '[data-panel][data-active="true"] [data-card-part="example"] p').last(),
