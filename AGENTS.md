...
Latest Chapter 02 Hero copy correction on 2026-09-20: the main title is “重新审视默认假设，由此形成新的设计思路。”, with a line break after the comma. Keep existing typography and natural-height layout. English title: “Revisit default assumptions. / Discover new design approaches.” This changes the chapter Hero only; the homepage Transform question remains unchanged.
